                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-danger">Data Album</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($albums as $data) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#editModal<?= $data['AlbumID'] ?>">Edit</a>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="" method="POST">
                                                                ...
                                                                <button type="submit" name="edit" class="btn btn-danger w-100">Simpan</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        $(document).ready(function() {
            $('#dataX').DataTable({
                "language": {
                    ...
                    "sInfo": "Menampilkan _START_ sampai _END_ dari _TOTAL_ album",
                    "sSearch": "Cari:",
