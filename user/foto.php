                ...
                <div class="container-fluid">
                        ...
                        <div class="collapse" id="collapseExample">
                            <div class="card card-body">
                                <form method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <button type="submit" name="submit" class="btn btn-danger w-100">Unggah</button>
                                </form>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-danger">Data Foto Anda</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($fotos as $data) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#hapusModal<?= $data['FotoID'] ?>">Hapus</a>
                                                </td>
                                            </tr>
        ...
        $(document).ready(function() {
            $('#dataX').DataTable({
                "language": {
                    ...
                    "sInfo": "Menampilkan _START_ sampai _END_ dari _TOTAL_ foto",
                    "sSearch": "Cari:",
