                            ...
                            <div class="col-lg-4 col-md-6 mb-4">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><small class="text-muted">Uploaded by <?= htmlspecialchars($data['Username']); ?> on <?= htmlspecialchars($data['TanggalUnggah']); ?></small></p>
                                        ...
                                        ?>
                                        <button class="btn btn-danger like-btn" data-fotoid="<?= $data['FotoID']; ?>"><i class="fas fa-heart"></i></button>
                                        <br>
                                        <hr>
                                        <span id="like-count-<?= $data['FotoID']; ?>"><?= $likeResult['likes']; ?> Likes</span>
                                        ...
                                        <form action="post_comment.php" method="POST">
                                            <div class="form-group">
                                                <textarea name="komentar" class="form-control" placeholder="Add a comment..."></textarea>
